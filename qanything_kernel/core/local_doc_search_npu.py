...
class LocalDocSearch:
    ...
    def init_cfg(self, args):
        ...
        if self.use_cpu:
            ...
            self.local_rerank_backend: RerankTorchBackend = RerankTorchBackend(self.use_cpu, args.device+":"+str(args.device_id))
            self.embeddings: EmbeddingTorchBackend = EmbeddingTorchBackend(self.use_cpu, args.device+":"+str(args.device_id))
